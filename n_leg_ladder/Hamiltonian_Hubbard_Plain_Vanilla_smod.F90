...
!--------------------------------------------------------------------
    ...
    submodule (Hamiltonian_main) ham_Hubbard_Plain_Vanilla_smod
      ...
      real(Kind=Kind(0.d0)) :: ham_Ty   = 1.d0      ! Hopping parameter   !#? declared ty
...
!--------------------------------------------------------------------
      Subroutine Ham_Set
          ...
          If (Irank_g == 0) then
             ...
             Write(unit_info,*) 'ty            : ', Ham_Ty  !#? added ty to i/o
          ...
          do nf = 1,N_FL
             ...
             Do I = 1,Latt%N
                ...
                If ( L2 > 1 ) then
                   ...
                   Op_T(1,nf)%O(I,  Iy) = cmplx(-Ham_Ty,    0.d0, kind(0.D0))  !#? mod. hops along y
                   Op_T(1,nf)%O(Iy, I ) = cmplx(-Ham_Ty,    0.d0, kind(0.D0))  !#? mod. hops along y
                endif
...
!--------------------------------------------------------------------
        Subroutine Ham_Trial()
          ...
          Do I = 1,Latt%N
             ...
             If (L2  > 1 ) Then
                Iy = Latt%nnlist(I,0,1)
                H0(I,  Iy) = -Ham_Ty *(1.d0  -   Delta)  !#? mod. hops along y
                H0(Iy, I ) = -Ham_Ty *(1.d0  -   Delta)  !#? mod. hops along y
             Endif
          Enddo
          Call  Diag(H0,U0,E0)
!!$          Do I = 1,Ndim
